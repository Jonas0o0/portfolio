...
const Contact = () => {
  return (
    <section id="contact" className="min-h-screen py-32 px-6 flex flex-col items-center justify-center bg-gray-900 text-white relative overflow-hidden">
      ...
      {/* Footer-like credit inside contact section for cohesion */}
      <div className="absolute bottom-10 w-full text-center text-gray-600 text-xs font-bold uppercase tracking-[0.5em]">
        Handcrafted with passion &copy; 2026
      </div>
    </section>
  );
};
